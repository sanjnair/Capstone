...
public final class Const {
    ...
    public static final String ID_WEB_CLIENT                    = ""; // Add your client ID HERE
    public static final String ID_ANDROID_CLIENT                = ""; // Add your client ID HERE
    public static final String ID_ANDROID_CLIENT_RELEASE        = ""; // Add your client ID HERE
    public static final String ID_ANDROID_CLIENT_RLS_INTERNAL   = ""; // Add your client ID HERE
